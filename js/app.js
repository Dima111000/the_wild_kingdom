    ...
    (() => {
                ...
                if (bodyLockStatus) {
                    ...
                    if (this.targetOpen.element) {
                        if (this.youTubeCode) {
                            ...
                            const urlVideo = `https://www.youtube.com/embed/${codeVideo}?rel=0&showinfo=0`;
                            const iframe = document.createElement("iframe");
                            iframe.setAttribute("allowfullscreen", "");
                            iframe.setAttribute("referrerpolicy", "strict-origin-when-cross-origin");
                            const autoplay = this.options.setAutoplayYoutube ? "autoplay;" : "";
                            iframe.setAttribute("allow", `${autoplay} accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; encrypted-media`);
        ...
        function initSliders() {
            if (document.querySelector(".swiper")) {
                new swiper_core_Swiper(".slider-hero", {
                    ...
                    loop: true,
                    navigation: {
                        prevEl: ".slider-hero__arrow--left",
                        nextEl: ".slider-hero__arrow--right"
                    },
                    breakpoints: {
                        0: {
                            centeredSlides: true,
                    ...
                    on: {
                        init: function(slider) {
                            slider.slides.forEach((slide => {
                                const imageSrc = slide.querySelector(".slider-hero__image img").getAttribute("src");
                                const sliderContent = slide.querySelector(".slider-hero__content");
                                const topImage = `\n\t\t\t\t\t\t\t<div class="slider-hero__top-image">\n\t\t\t\t\t\t\t\t<img src="${imageSrc}" alt="Image">\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t`;
                                sliderContent.insertAdjacentHTML("beforeend", topImage);
                            }));
                        }
                    }
                });
                new swiper_core_Swiper(".reviews__slider", {
                    ...
                    speed: 800,
                    navigation: {
                        prevEl: ".slider-reviews__arrow--prev",
                        nextEl: ".slider-reviews__arrow--next"
                    },
                    on: {}
                });
            }
